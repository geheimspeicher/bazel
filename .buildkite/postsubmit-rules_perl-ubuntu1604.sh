...
echo '--- Cloning'
git clone https://github.com/geheimspeicher/rules_perl .downstream-projects/rules_perl || exit $?
cd .downstream-projects/rules_perl
...
cd ../..
python3 .buildkite/failed_testlogs.py .downstream-projects/rules_perl/bep.json | while read logfile; do buildkite-agent artifact upload $logfile; done
