...
echo '--- Cloning'
git clone https://github.com/geheimspeicher/rules_scala .downstream-projects/rules_scala || exit $?
cd .downstream-projects/rules_scala
...
cd ../..
python3 .buildkite/failed_testlogs.py .downstream-projects/rules_scala/bep.json | while read logfile; do buildkite-agent artifact upload $logfile; done
