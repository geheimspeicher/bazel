...
echo '--- Cloning'
git clone https://github.com/geheimspeicher/rules_python .downstream-projects/rules_python || exit $?
cd .downstream-projects/rules_python
...
cd ../..
python3 .buildkite/failed_testlogs.py .downstream-projects/rules_python/bep.json | while read logfile; do buildkite-agent artifact upload $logfile; done
