...
echo '--- Cloning'
git clone https://github.com/geheimspeicher/rules_rust .downstream-projects/rules_rust || exit $?
cd .downstream-projects/rules_rust
...
cd ../..
python3 .buildkite/failed_testlogs.py .downstream-projects/rules_rust/bep.json | while read logfile; do buildkite-agent artifact upload $logfile; done
