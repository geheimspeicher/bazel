...
echo '--- Cloning'
git clone https://github.com/geheimspeicher/rules_closure .downstream-projects/rules_closure || exit $?
cd .downstream-projects/rules_closure
...
cd ../..
python3 .buildkite/failed_testlogs.py .downstream-projects/rules_closure/bep.json | while read logfile; do buildkite-agent artifact upload $logfile; done
