...
echo '--- Cloning'
git clone https://github.com/geheimspeicher/rules_typescript .downstream-projects/rules_typescript || exit $?
cd .downstream-projects/rules_typescript
...
cd ../..
python3 .buildkite/failed_testlogs.py .downstream-projects/rules_typescript/bep.json | while read logfile; do buildkite-agent artifact upload $logfile; done
