...
echo '--- Cloning'
git clone https://github.com/geheimspeicher/rules_go .downstream-projects/rules_go || exit $?
cd .downstream-projects/rules_go
...
cd ../..
python3 .buildkite/failed_testlogs.py .downstream-projects/rules_go/bep.json | while read logfile; do buildkite-agent artifact upload $logfile; done
