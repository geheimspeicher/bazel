...
echo '--- Cloning'
git clone https://github.com/geheimspeicher/rules_appengine .downstream-projects/rules_appengine || exit $?
cd .downstream-projects/rules_appengine
...
cd ../..
python3 .buildkite/failed_testlogs.py .downstream-projects/rules_appengine/bep.json | while read logfile; do buildkite-agent artifact upload $logfile; done
